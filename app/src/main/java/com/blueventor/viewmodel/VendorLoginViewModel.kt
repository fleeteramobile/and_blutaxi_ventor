...
@HiltViewModel
class VendorLoginViewModel @Inject constructor(val vendorLoginRepository: VendorLoginRepository) : ViewModel(){
    ...
    suspend fun getVendorLoginAccess(requestloginaccess: Requestloginaccess){
