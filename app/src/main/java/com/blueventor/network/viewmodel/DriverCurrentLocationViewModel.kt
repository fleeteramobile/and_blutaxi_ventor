...
import com.blueventor.network.repository.DriverCurrentLocationRepository
...
@HiltViewModel
class DriverCurrentLocationViewModel @Inject constructor(val driverCurrentLocationRepository: DriverCurrentLocationRepository): ViewModel(){
private val _uiState = MutableStateFlow<UiState<ResponseGetDriverLocation>>(UiState.Idle)
val uiState: StateFlow<UiState<ResponseGetDriverLocation>> = _uiState
    ...
    fun getDriverDetails(requestGetDriverLocation: RequestGetDriverLocation) {
        ...
        viewModelScope.launch {
            ...
            _uiState.value = driverCurrentLocationRepository.getDriverLocation(requestGetDriverLocation)
        }
